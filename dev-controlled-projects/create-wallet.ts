...
async function main() {
  ...
  if (!entitySecret) {
    ...
    console.log("\nACTION REQUIRED: Register this secret in the Circle Developer Console:");
    console.log("  1. Go to https://console.circle.com");
    console.log("  2. Navigate to: Configurator > Entity Secret Ciphertext");
    console.log("  3. Paste your entity secret and click Register");
    const rl2 = readline.createInterface({ input: process.stdin, output: process.stdout });
    await new Promise<void>((resolve) =>
      rl2.question("\nPress Enter once you have registered the entity secret in Console... ", () => {
        rl2.close();
        resolve();
      })
    );
